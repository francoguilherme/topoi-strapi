...
export interface ApiArtigoArtigo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    xml: Schema.Attribute.Media<'files'>;
  };
}

export interface ApiAssuntoAssunto extends Struct.CollectionTypeSchema {
  collectionName: 'assuntos';
  info: {
    displayName: 'Assunto';
    pluralName: 'assuntos';
    singularName: 'assunto';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAutorAutor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    artigos_traduzidos: Schema.Attribute.Relation<
      'manyToMany',
      'api::artigo.artigo'
    >;
    ...
    interesses: Schema.Attribute.Component<'simples.texto', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiDossieDossie extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dossie.dossie'>;
    pagina: Schema.Attribute.Component<'simples.pagina', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
