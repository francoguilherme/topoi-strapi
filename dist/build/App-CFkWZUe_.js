...
`,hr=y(C)`
  ...
  background: ${({theme:e})=>e.colors.neutral0};
  opacity: 0.7;
`,pr=e=>e.isDeleting?{id:i("asset-details.delete.loading"),defaultMessage:"Deleting the file…"}:e.isCropCopying?{id:i("asset-details.crop.loading"),defaultMessage:"Saving the cropped copy…"}:e.isReplacing?{id:i("asset-details.replace.loading"),defaultMessage:"Replacing the file…"}:null,fr=y(Xe)`
  width: 1.6rem;
  height: 1.6rem;
...
`,po=({asset:e,orderedItemKeys:s,onAssetItemClick:n})=>{const{formatMessage:r}=A(),o=ye(e.mime,e.ext),{isMovePending:a}=Y()??{isMovePending:!1},{attributes:l,listeners:d,setNodeRef:c,isDragging:h}=ns(e),{isSelected:f,toggle:x,selectRange:j}=ne(),m=ue(e.id),g=f(m),p=w=>{w.shiftKey?j(s,m):w.metaKey||w.ctrlKey?x(m):n(e.id)},M=w=>{w.key==="Enter"?(w.preventDefault(),n(e.id)):w.key===" "&&(w.preventDefault(),x(m))},b=w=>{w.stopPropagation(),n(e.id)},D=w=>{w.stopPropagation(),w.shiftKey?j(s,m):x(m)};return t.jsxs(Xr,{ref:c,...l,...d,$isDragging:h,$isMovePending:a,$isSelected:g,tabIndex:0,role:"listitem",onDragStart:w=>w.preventDefault(),onClick:p,onKeyDown:M,children:[t.jsxs(lo,{children:[t.jsx(Jr,{onKeyDown:w=>w.stopPropagation(),children:t.jsx(be,{checked:g,onClick:D,"aria-label":r({id:i("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})}),t.jsx(io,{asset:e})]}),t.jsx(_s,{children:t.jsxs(co,{alignItems:"center",gap:2,children:[t.jsx(uo,{children:t.jsx(o,{width:20,height:20})}),t.jsx(ho,{type:"button",onClick:b,children:t.jsx(go,{textColor:"primary800",ellipsis:!0,children:e.name})}),t.jsx(G,{label:r({id:i("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",onClick:w=>w.stopPropagation(),children:t.jsx(Fe,{})})]})})]})},fo=({assets:e,folders:s=[],onAssetItemClick:n})=>{const r=s.length+e.length,o=[...s.map(a=>ge(a.id)),...e.map(a=>ue(a.id))];return r===0?null:t.jsxs(ve.Root,{gap:4,role:"list","data-testid":"assets-grid",children:[s.length>0&&t.jsx(eo,{children:t.jsx(ve.Root,{gap:4,children:s.map(a=>t.jsx(ve.Item,{col:3,m:4,s:6,xs:12,children:t.jsx(ro,{folder:a,orderedItemKeys:o})},`folder-${a.id}`))})}),e.map(a=>t.jsx(ve.Item,{col:3,m:4,s:6,xs:12,direction:"column",alignItems:"stretch",children:t.jsx(po,{asset:a,orderedItemKeys:o,onAssetItemClick:n})},a.id))]})},mo={view:"STRAPI_UPLOAD_LIBRARY_VIEW"},xe={GRID:0,TABLE:1},vt=[{name:"name",label:{id:i("list.table.header.name"),defaultMessage:"name"}},{name:"createdAt",label:{id:i("list.table.header.creationDate"),defaultMessage:"creation date"}},{name:"updatedAt",label:{id:i("list.table.header.lastModified"),defaultMessage:"last modified"}},{name:"size",label:{id:i("list.table.header.size"),defaultMessage:"size"}},{name:"actions",label:{id:i("list.table.header.actions"),defaultMessage:"actions"},isVisuallyHidden:!0}],xo=y(qs)`
  width: 100%;
